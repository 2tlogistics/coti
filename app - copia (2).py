...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, 'SOFT CORPORATE OFFER - SCO', 0, 1, 'C')
        if self.page_no() > 1:
...
def generate_pdf(contact_name, email, company_name, items, incoterm, delivery_to):
    ...
    pdf.cell(0, 5, txt="TEL: 58-412-927-2908", ln=True, align='R')
    pdf.cell(0, 5, txt="E-mail: jtoledo@2tlogistics.us", ln=True, align='R')
    pdf.cell(0, 5, txt="URL: http://2tlogistics.us", ln=True, align='R')
